        ...
        <div className="w-full max-w-md mx-auto">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                    <label htmlFor="register-name" className="text-sm font-medium text-stone-700 dark:text-zinc-300">
                        Full Name
                    </label>
                    <input
                        id="register-name"
                ...
                <div className="flex flex-col gap-1.5">
                    <label htmlFor="register-email" className="text-sm font-medium text-stone-700 dark:text-zinc-300">
                        Email
                    </label>
                    <input
                        id="register-email"
                ...
                <div className="flex flex-col gap-1.5">
                    <label htmlFor="register-password" className="text-sm font-medium text-stone-700 dark:text-zinc-300">
                        Password
                    </label>
                    <input
