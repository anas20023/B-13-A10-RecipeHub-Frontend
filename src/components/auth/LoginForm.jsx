        ...
        <div className="w-full max-w-md mx-auto">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <Button
                    type="submit"
                    disabled={loading}
                    className="mt-2 w-full rounded-xl bg-linear-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-2.5 text-sm shadow-md shadow-orange-500/20 transition-all duration-300 hover:-translate-y-0.5"
                >
                ...
                <Button
                    ...
                    className="flex items-center justify-center gap-2.5 w-full rounded-xl border border-stone-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-stone-50 dark:hover:bg-zinc-700 text-stone-700 dark:text-zinc-100 font-semibold py-2.5 text-sm transition-all duration-200"
                >
